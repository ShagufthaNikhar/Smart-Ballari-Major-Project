...
function updateMap(data, intent) {
  ...
  if (data.lat && data.lng) {
    ...
    document.getElementById('map-panel-label').innerText =
...
function updateMapInfoPanel(data, intent) {
  ...
  document.getElementById('map-info-title').innerText =
    titleMap[intent] || '📍 Location Info';
